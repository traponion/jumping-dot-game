import { Player, Camera, TrailPoint, DeathMark, Particle } from '../types/GameTypes.js';
import { StageData, Spike } from '../core/StageLoader.js';
...
export class RenderSystem {
    ...
    renderStage(stage: StageData): void {
        ...
        if (stage.leftEdgeMessage) {
            ...
            this.ctx.fillText(stage.leftEdgeMessage.text, stage.leftEdgeMessage.x, stage.leftEdgeMessage.y);
        }
        
        if (stage.leftEdgeSubMessage) {
            this.ctx.font = '12px monospace';
            this.ctx.fillText(stage.leftEdgeSubMessage.text, stage.leftEdgeSubMessage.x, stage.leftEdgeSubMessage.y);
        }
    }
