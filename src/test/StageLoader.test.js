...
describe('StageLoader', () => {
  ...
  describe('validateStage', () => {
    ...
    it('should validate platform structure', () => {
      ...
      expect(() => stageLoader.validateStage(stageWithInvalidPlatform)).toThrow('Invalid platform data');
    });
    ...
    it('should validate spike structure', () => {
      ...
      expect(() => stageLoader.validateStage(stageWithInvalidSpike)).toThrow('Invalid spike data');
    });
  });
