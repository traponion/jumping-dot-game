...
// These are applied once when the setup file is imported, before any tests run.
...
// JSDOM's requestAnimationFrame is replaced with a setTimeout-based implementation for better control in tests.
...
// --- HOOKS ---
// These run before each test or test suite.
